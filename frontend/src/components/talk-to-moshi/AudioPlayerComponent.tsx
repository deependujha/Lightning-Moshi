...
const UserAudioBoxCSS = "bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"
const BotAudioBoxCSS = "bg-gradient-to-r from-cyan-500 to-blue-500"

const AudioPlayerComponent = ({ sender }: Props) => {
  ...
  return (
    <div className="flex justify-center items-center gap-2 py-3">
      ...
      <div className={`flex items-center gap-2  rounded-3xl px-4 py-1 ${sender === "user" ? UserAudioBoxCSS : BotAudioBoxCSS}`}>
        {isPlaying ? (
